    ...
    <div className={`relative z-${isOpen ? '10' : '0'} flex flex-col justify-center py-6 sm:py-12`}>
      <div className="relative items-center w-full max-w-screen-sm mx-auto">
        <div id="bouton" className="relative w-full group">
          ...
          >
            <div
              className="relative cursor-pointer flex items-center justify-between w-full px-10 py-2 border border-yellow-200 bg-yellow-100 transition-all duration-150 font-semibold  hover:bg-yellow-200 "
              onClick={() => handleItemClick('Hindi')}
            >
              Hindi
            </div>
            <div
              className="relative cursor-pointer flex items-center justify-between w-full px-10 py-2 border border-stone-200 bg-yellow-100 transition-all duration-150 font-semibold  hover:bg-yellow-200 " 
